...
<body>
	...
	<nav>
		<ul>
			...
			<li></li><li></li>
			<li></li><li><spam style="color:#fff;"><?php echo $_SESSION["usuario"]; ?></spam></li>
	...
	<img class="atras" src="../images/atras.png" alt="Atras"></a>Contactos</h1>
...
<table class="datos" style="width:600px;">
				<tr>
					<th>ID</th>
					<th>NOMBRE</th>
...
$query="SELECT id_contacto,nombre,fecha_alta,movil,email_personal,calle,num_ext,num_int,estado,municipio,
