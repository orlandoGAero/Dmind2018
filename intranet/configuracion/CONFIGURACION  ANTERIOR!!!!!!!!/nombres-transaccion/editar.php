...
<?php
  ...
  $query="select * from nombres where id_nombre=$id_nombre";
  $result=mysql_query($query);
 while($fila=mysql_fetch_array($result))
 {
  	echo '<input type="hidden" name="id_nombre" value="'.$fila["id_nombre"].'" /><br><br>';
  	echo '<input name="nombre" value="'.$fila["nombre"].'" type="text"/><br><br><br>';
?>
<?php
  }
?>
