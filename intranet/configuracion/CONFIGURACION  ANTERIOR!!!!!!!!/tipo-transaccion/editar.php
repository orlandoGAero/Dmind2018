...
<form action="actualiza.php" class="regusuario"> 
	<h2 class="formarriba">EDITAR TIPO TRANSACCIÓN</h2>
<div class="camps">
	<br><label>Nombre :</label>
<?php
  include ('../../Conexion.php');
  $id_tipo=$_GET["id_tipo"];
  $query = "select * from tipo_transaccion where id_tipo_transaccion=$id_tipo";
  $result=mysql_query($query);
  while($fila=mysql_fetch_array($result))
  {
  	echo '<input type="hidden" name="id_tipo" value="'.$fila["id_tipo_transaccion"].'" /><br><br>';
  	echo '<input name="nombre_tipo" value="'.$fila["nombre_tipo_transaccion"].'" type="text"/><br><br><br>';
?>
<?php
  }
?>
