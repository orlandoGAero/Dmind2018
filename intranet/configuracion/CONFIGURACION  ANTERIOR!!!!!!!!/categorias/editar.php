...
$id_categ=$_GET["id_categoria"];
  ...
  $query="select * from categorias where id_categoria=$id_categ";
  $result=mysql_query($query);
  while($fila=mysql_fetch_array($result)){
  	echo '<input type="hidden" name="id_categoria" value="'.$fila["id_categoria"].'" /><br><br>';
  	echo '<input name="nombre_categoria" value="'.$fila["nombre_categoria"].'" type="text"/><br><br><br>';
?>
<?php
  }
?>
