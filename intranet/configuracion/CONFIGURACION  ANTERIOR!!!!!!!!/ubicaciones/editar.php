...
<?php
  ...
  $query = "select * from ubicaciones where id_ubicacion=$id_ubicacion";
  $result=mysql_query($query);
  while($fila=mysql_fetch_array($result))
  {
  	echo '<input type="hidden" name="id_ubicacion" value="'.$fila["id_ubicacion"].'" /><br><br>';
  	echo '<input name="nombre_ubicacion" value="'.$fila["nombre_ubicacion"].'" type="text"/><br><br><br>';
?>
<?php
  }
?>
