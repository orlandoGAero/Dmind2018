		...
		*/
		...
		public function registrar_clasificacion($nomCl) {
			...
			if ($band == 0) {
				...
				$sql = "INSERT INTO clasificacion_egresos(nom_clasifi)
						VALUES ('".$nomCl."')";
		...
		public function editar_clasificacion($idcl,$nomCl) {
			...
			if ($band == 0) {
				...
				$sql = "UPDATE clasificacion_egresos
		...
		public function eliminar_clasifi($idCl)	{
			...
			if($band == 0){
				$sql = "DELETE FROM clasificacion_egresos
						WHERE id_clasifi =" . $idCl;
		...
		*/
		...
		public function registrar_concepto($nomCo) {
			...
			if ($band == 0) {
				...
				$sql = "INSERT INTO conceptos_egresos(nom_concepto)
						VALUES ('".$nomCo."')";
				$ejecutar = mysql_query($sql) or die(mysql_error());
		...
		public function eliminar_concepto($idCo)	{
			...
			if($band == 0){
				$sql = "DELETE FROM conceptos_egresos
						WHERE id_concepto =" . $idCo;
				$result = mysql_query($sql);
				$this -> msjOk = "Registro eliminado exitosamente.";
				return $result;
		...
		*/
		...
		public function registrar_destino($nomDes) {
			...
			if ($band == 0) {
				...
				$sql = "INSERT INTO destinos_egresos(nom_destino)
						VALUES ('".$nomDes."')";
				$ejecutar = mysql_query($sql) or die(mysql_error());
		...
		public function eliminar_destino($idDes)	{
			...
			if($band == 0){
				$sql = "DELETE FROM destinos_egresos
						WHERE id_destino =" . $idDes;
				$result = mysql_query($sql);
				$this -> msjOk = "Registro eliminado exitosamente.";
				return $result;
		...
		*/
		...
		public function registrar_origen($nomOri) {
			...
			if ($band == 0) {
				...
				$sql = "INSERT INTO origenes_egresos(nom_origen)
						VALUES ('".$nomOri."')";
				$ejecutar = mysql_query($sql) or die(mysql_error());
		...
		public function eliminar_origen($idOrig)	{
			...
			if($band == 0){
				$sql = "DELETE FROM origenes_egresos
		...
		*/
		...
		public function registrar_status($nomSta) {
			...
			if ($band == 0) {
				...
				$sql = "INSERT INTO status_egresos(nom_status)
						VALUES ('".$nomSta."')";
				$ejecutar = mysql_query($sql) or die(mysql_error());
		...
		public function eliminar_status($idStatus)	{
			...
			if($band == 0){
				$sql = "DELETE FROM status_egresos
