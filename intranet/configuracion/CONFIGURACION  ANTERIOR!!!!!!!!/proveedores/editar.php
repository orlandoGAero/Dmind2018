...
<body>
	...
	<nav>
		<ul>
			...
			<a href="./detalle.php?id_prov=<?php echo $_GET["id_prov"] ?>"><li><img src="../../images/volver.png" /><b>Atras</b></li></a><li></li><li></li><li></li>
...
<center>
<?php
$query="SELECT C.id,nombre,movil,nombre_areacontacto,C.id_contacto from proveedorxcontacto C 
