...
<?php
	$band = 0;
	if($fnDirecciones -> modificarDireccion($_REQUEST['txtidDir'],$_REQUEST['txt_calle'],$_REQUEST['txt_ext'],$_REQUEST['txt_int'],$_REQUEST['txt_col'],$_REQUEST['txt_loc'],$_REQUEST['txt_ref'],$_REQUEST['txt_mun'],$_REQUEST['txt_est'],$_REQUEST['txt_pai'],$_REQUEST['txt_cp'],$_REQUEST['txt_suc'],$_REQUEST['txt_gps'])) {
		$band = 0;
	}
	else {
