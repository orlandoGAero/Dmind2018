<?php
 if(isset($_POST["id_subcategoria"]))
 {
    ...
    $strConsulta = "SELECT DISTINCT P.id_division, nombre_division FROM productos P INNER JOIN
                    division D on P.id_division=D.id_division
                    where id_categoria=$id_categoria and P.id_subcategoria=".$_POST["id_subcategoria"];
