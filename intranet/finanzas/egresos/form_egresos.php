		...
		<div class="">
			...
			<ul>
				<li>
					...
					<input type="text" name="txtEfectCompr[<?=$i?>]" id="efectCompro" value="EGRESO" readonly maxlength="6" autocomplete="off" required>
				</li>
				<li>
					<label>Versión:<span>&nbsp;*</span></label>
					<input type="text" name="txtVersion[<?=$i?>]" id="Version<?=$i?>" maxlength="5" autocomplete="off" required>
				</li>
				<li>
					<label>Tipo de Comprobante:<span>&nbsp;*</span></label>
					<input type="text" name="txtTipoCompr[<?=$i?>]" id="TipoComprobante<?=$i?>" maxlength="7" autocomplete="off" required>
				</li>
				<li>
					<label>Lugar de Expedición:<span>&nbsp;*</span></label>
					<input type="text" name="txtLugarExped[<?=$i?>]" id="LugarExpedicion<?=$i?>" maxlength="50" autocomplete="off" required>
				</li>
				<li>
					<label>Fecha:<span>&nbsp;*</span></label>
					<input type="text" name="txtFecha[<?=$i?>]" id="Fecha<?=$i?>" maxlength="10" autocomplete="off" required pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}">
				</li>
				<li>
					<label>Hora:<span>&nbsp;*</span></label>
					<input type="text" name="txtHora[<?=$i?>]" id="Hora<?=$i?>" maxlength="8" autocomplete="off" required pattern="^(?:(?:([01]?\d|2[0-3]):)?([0-5]?\d):)?([0-5]?\d)$" >
				</li>
				<li>
					<label>RFC Emisor:<span>&nbsp;*</span></label>
					<input type="text" name="txtRfcEmisor[<?=$i?>]" id="RfcEmisor<?=$i?>" maxlength="13" autocomplete="off" required>
				</li>
				<li>
					<label>Razón Social Emisor:<span>&nbsp;*</span></label>
					<input type="text" name="txtNombreEmisor[<?=$i?>]" id="NombreEmisor<?=$i?>" maxlength="100" autocomplete="off" required>
				</li>
				<li>
					<label>
				...
				<li>
					...
					<input type="text" name="txtRfcReceptor[<?=$i?>]" id="RfcReceptor<?=$i?>" maxlength="13" autocomplete="off" required>
				</li>
				<li>
					<label>Razón Social Receptor:<span>&nbsp;*</span></label>
					<input type="text" name="txtNombreReceptor[<?=$i?>]" id="NombreReceptor<?=$i?>" maxlength="100" autocomplete="off" required>
				</li>
				<li>
				...
				<li>
					...
					<input type="text" name="txtSerie[<?=$i?>]" id="Serie<?=$i?>" maxlength="50" autocomplete="off" required>
				</li>
				<li>
					<label>No. Folio:<span>&nbsp;*</span></label>
					<input type="text" name="txtFolio[<?=$i?>]" id="Folio<?=$i?>" maxlength="10" autocomplete="off" required>
				</li>
				...
				<div id="conceptos-comprobante<?=$i?>">
					...
					<li>
						...
						<input type='text' name='conceptosFactura[<?=$i?>][<?=$numC?>][baseImpuestoC]' maxlength='10' value="<?=$concepto['baseConceptoE']?>" autocomplete='off'>
					</li>
					<li>
						<label>Impuesto del Concepto <?=$numC?>:</label>
						<input type='text' name='conceptosFactura[<?=$i?>][<?=$numC?>][impuestoC]' maxlength='20' value="<?=$concepto['impuestoConceptoE']?>" autocomplete='off'>
					</li>
					<li>
						<label>Tipo Factor del Impuesto Concepto <?=$numC?>:</label>
						<input type='text' name='conceptosFactura[<?=$i?>][<?=$numC?>][tipoFactorImpuestoC]' maxlength='20' value="<?=$concepto['tipoFactorConceptoE']?>" autocomplete='off'>
					</li>
					<li>
						<label>Tasa/Cuota del Impuesto Concepto <?=$numC?>:</label>
						<input type='text' name='conceptosFactura[<?=$i?>][<?=$numC?>][tasaCuotaImpuestoC]' maxlength='10' value="<?=$concepto['tasaCuotaConceptoE']?>" autocomplete='off'>
					</li>
					<li>
						<label>Importe del Impuesto Concepto <?=$numC?>:</label>
						<input type='text' name='conceptosFactura[<?=$i?>][<?=$numC?>][importeImpuestoC]' maxlength='10' value="<?=$concepto['importeImpuestoConceptoE']?>" autocomplete='off'>
					</li>
				...
				<li>
					...
					<input type="text" name="txtSubtotal[<?=$i?>]" id="Subtotal<?=$i?>" maxlength="15" autocomplete="off" required>
				</li>
				<li>
					<label>IVA ($):<span>&nbsp;*</span></label>
					<input type="text" name="txtIva[<?=$i?>]" id="Iva<?=$i?>" maxlength="15" autocomplete="off" required>
				</li>
				<li>
					<label>Total ($):<span>&nbsp;*</span></label>
					<input type="text" name="txtTotal[<?=$i?>]" id="Total<?=$i?>" maxlength="15" autocomplete="off" required>
				</li>
				<li>
					<label>Moneda:<span>&nbsp;*</span></label>
					<input type="text" name="txtMoneda[<?=$i?>]" id="Moneda<?=$i?>" maxlength="5" autocomplete="off" required>
				</li>
				<li>
					<label>Método de Pago:<span>&nbsp;*</span></label>
					<input type="text" name="txtMetodoPago[<?=$i?>]" id="MetodoPago<?=$i?>" maxlength="50" autocomplete="off" required>
				</li>
				<li>
				...
				<li>
					...
					<input type="text" name="txtFormaPago[<?=$i?>]" id="FormaPago<?=$i?>" maxlength="50" autocomplete="off" required>
				</li>
				<li>
				...
				<li>
					...
					<input type="text" name="txtNombreImpuesto[<?=$i?>]" id="NombreImpuesto<?=$i?>" maxlength="50" autocomplete="off" required>
				</li>
				<li>
					<label>Total Impuesto ($):<span>&nbsp;*</span></label>
					<input type="text" name="txtTotalImpuesto[<?=$i?>]" id="TotalImpuesto<?=$i?>" maxlength="15" autocomplete="off" required>
				</li>
				<li>
				...
				<li>
					...
					<input type="text" name="txtTasaImpuesto[<?=$i?>]" id="tasaOCuotaImpuesto<?=$i?>" maxlength="15" autocomplete="off" required>
				</li>
				<li>
				...
				<li>
					...
					<input type="text" name="txtFolioFiscal[<?=$i?>]" id="FolioFiscal<?=$i?>" maxlength="50" autocomplete="off" required>
				</li>
				<li>
					<label>Fecha Timbrado:<span>&nbsp;*</span></label>
					<input type="text" name="txtFechaTimbr[<?=$i?>]" id="FechaTimbrado<?=$i?>" maxlength="10" autocomplete="off" required pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" placeholder="dd-mm-yyyy">
				</li>
				<li>
					<label>Hora Timbrado:<span>&nbsp;*</span></label>
					<input type="text" name="txtHoraTimbr[<?=$i?>]" id="HoraTimbrado<?=$i?>" maxlength="8" autocomplete="off" required pattern="^(?:(?:([01]?\d|2[0-3]):)?([0-5]?\d):)?([0-5]?\d)$" placeholder="hh:mm:ss">
				</li>
				<li>
					<label class="label-textarea">Sello:<span>&nbsp;*</span></label>
					<textarea name="txtSello[<?=$i?>]" class="sello" id="Sello<?=$i?>" cols="50" rows="8" autocomplete="off" required></textarea>
				</li>
				<li>
...
<hr style="height: 5px; background-color: #00f">
<script>
